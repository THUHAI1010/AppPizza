...
public class FragmentHome extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       View view = inflater.inflate(R.layout.fragmenthome,container,false);
        ...
        if (currentTime.getHours() < 12) {
            txtslogan.setText("Thực đơn trong Sáng nay!");
            ...
            txtslogan.setText("Thực đơn trong Chiều nay!");
            foodArrayList = new ArrayList<>();
            foodAdapter = new FoodAdapter(foodArrayList,getActivity());
            GridLayoutManager gridLayoutManager = new GridLayoutManager(getActivity(),2);
            rcvmonan.setLayoutManager(gridLayoutManager);
            ...
            txtslogan.setText("Thực đơn trong Tối nay!");
            foodArrayList = new ArrayList<>();
            foodAdapter = new FoodAdapter(foodArrayList,getActivity());
            GridLayoutManager gridLayoutManager = new GridLayoutManager(getActivity(),2);
            rcvmonan.setLayoutManager(gridLayoutManager);
    ...
    public void renewItems(View view) {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (i == 0) {
                sliderItem.setImageurl("https://www.thepizzacompany.vn/images/thumbs/000/0002833_(1200Wx480H)px-opt2.jpeg");
            }
            else if(i == 1) {
                sliderItem.setImageurl("https://www.thepizzacompany.vn/images/thumbs/000/0002956_BannerSlider-Combo%20(1).jpeg");
            }
            else if(i == 2) {
                sliderItem.setImageurl("https://www.thepizzacompany.vn/images/thumbs/000/0002888_Slider-1200x480-2.jpeg");
            }
            else if(i == 3) {
                sliderItem.setImageurl("https://www.thepizzacompany.vn/images/thumbs/000/0002938_Banner-Slider-Pepsi-2.jpeg");
            }
            else if(i == 4) {
                sliderItem.setImageurl("https://www.thepizzacompany.vn/images/thumbs/000/0002829_Banner-Web_1200-x-480%20(2).jpeg");
            }
            else if(i == 5) {
                sliderItem.setImageurl("https://www.thepizzacompany.vn/images/thumbs/000/0002936_Banner-Slider-Pepsi-1.jpeg");
            }
            else if(i == 6) {
                sliderItem.setImageurl("https://www.thepizzacompany.vn/images/thumbs/000/0002845_Bogo_T3-T4_BannerSlider.jpeg");
            }
            else if(i == 7) {
                sliderItem.setImageurl("https://www.thepizzacompany.vn/images/thumbs/000/0002870_BannerSlider.jpeg");
            }
            else {
                sliderItem.setImageurl("https://www.thepizzacompany.vn/images/thumbs/000/0002854_50-OFF-HDE_BannerSlider.jpeg");}
