...
//        }
        setDarkModeSwitch();
        map.setOnClickListener(v -> startActivity(new Intent(getActivity(), MapActivity.class)));
        history.setOnClickListener(v -> Objects.requireNonNull(getActivity()).getSupportFragmentManager().beginTransaction().replace(R.id.fr_l, new FragmentHistory()).commit());
        txteditprofile.setOnClickListener(v -> Objects.requireNonNull(getActivity()).getSupportFragmentManager().beginTransaction().replace(R.id.fr_l, new FragmentEditProfile()).commit());
        txtchangepassword.setOnClickListener(v -> Objects.requireNonNull(getActivity()).getSupportFragmentManager().beginTransaction().replace(R.id.fr_l, new FragmentChangePassword()).commit());
